...
右键“查看源代码”发现，并没有我们写的for循环语句，而是直接的10条Hello World ，这就说明这个循环是在服务端完成的，而非浏览器（客户端）来完成。也就是说，在数据在服务端时已经处理完，直接输出10条语句发到客户端，这样客户端接收到后是不用做其他js上的运算的。这与JSP很是相似。
...
![1561560328462](assets/1561560328462.png)
