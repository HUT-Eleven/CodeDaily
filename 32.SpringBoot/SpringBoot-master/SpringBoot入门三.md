...
**！！！到此已经可以连接数据库了，之后可以自定义数据源（四要素+驱动jar包=连接数据库）**
...
3、用@Mapper（单个）和@MapperScan（批量）扫描dao接口，**这是必不可少的**
...
![](D:\AAAElevenFile\now\CodeDaily\32.SpringBoot\SpringBoot-master\images\2019-03-09_180006.png)
